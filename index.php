    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Q-FOOD</a>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#home" class="nav__link active-link">Beranda</a></li>
                        <li class="nav__item"><a href="propil.php" class="nav__link">Profil</a></li>
                        <li class="nav__item"><a href="#menu" class="nav__link">Menu</a></li>
                        <li class="nav__item"><a href="tentang.php" class="nav__link">Tentang</a></li>
                         <li class="nav__item"><a href="lacak_pesanan.php" class="nav__link">Lacak Pesanan</a></li>    
                        <li><i class='bx bx-moon change-theme' id="theme-button"></i></li>
                        <li class="nav__item">
                        
                        <li class="nav__item">
                         <a href="logout.php" class="nav__link" id="logoutLink"><i class='bx bx-log-out'></i> Logout</a>
                        </li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Q-FOOD</h1>
                        <h2 class="home__subtitle">Cobalah makanan terbaik <br> minggu ini.</h2>
                        <a href="#menu" class="button">Lihat Menu</a>
                    </div>
    
                    <img src="assets/img/qfood.png" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Kenapa Harus <br> Q-FOOD?</h2>
                        <p class="about__description">Q-FOOD adalah aplikasi pemesanan makanan online yang memudahkan Anda untuk memesan makanan favorit dengan cepat, mudah, dan praktis. Cukup pilih menu, isi data, unggah bukti bayar, dan tunggu makanan diantar!</p>
            ...
            <section class="services section bd-container" id="services">
                ...
                <h2 class="section-title">Layanan kami yang luar biasa</h2>
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Pelayanan Hebat</h3>
                        <p class="services__description"> kami menghadirkan pengalaman pemesanan makanan yang cepat dan praktis, dengan cita rasa terbaik. Kami berkomitmen menyajikan menu berkualitas dan pelayanan yang memuaskan.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Cepat, Lezat, dan Siap Antar!</h3>
                        <p class="services__description">menghadirkan layanan makanan cepat saji terbaik dengan rasa istimewa dan proses pemesanan yang super mudah. Nikmati berbagai menu favorit Anda yang siap dikirim langsung ke rumah dalam hitungan menit. Tanpa antre, tanpa ribet, tinggal klik!</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">pesanan Anda akan dikirim langsung ke lokasi tujuan dengan cepat, aman, dan tepat waktu.
                </div>
            </section>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="menu__content">
            <div style="position: relative;">
                <img src="uploads/<?= $row['gambar'] ?>" alt="" class="menu__img">
                <?php if ($row['stok'] <= 0): ?>
                    <div style="
                        position: absolute;
                        top: 0;
            ...
            <h3 class="menu__name"><?= htmlspecialchars($row['nama']) ?></h3>
            <span class="menu__detail"><?= htmlspecialchars($row['detail']) ?></span>
            <span class="menu__preci">Rp <?= number_format($row['harga'], 0, ',', '.') ?></span>

            <?php if ($row['stok'] > 0): ?>
                <a href="form_pesan.php?menu=<?= urlencode($row['nama']) ?>&harga=<?= $row['harga'] ?>" class="button menu__button">
                    <i class='bx bx-cart-alt'></i>
                </a>
            <?php else: ?>
                <button class="button menu__button" style="background: gray; cursor: not-allowed;" disabled>
                    <i class='bx bx-cart-alt'></i>
                </button>
            <?php endif; ?>
        </div>
    <?php endwhile; ?>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data">
                        <span class="section-subtitle app__initial">Web</span>
                        <h2 class="section-title app__initial">Nikmati Semua Fitur Langsung di Website!</h2>
                        <p class="app__description">Tanpa perlu instal aplikasi, Anda sudah bisa memesan makanan, melakukan reservasi, melacak status pengantaran, dan menikmati berbagai layanan kami langsung melalui situs Q-FOOD. Praktis, cepat, dan bisa diakses dari mana saja!</p>
                    ...
                    <img src="assets/img/hpqfood.jpeg" alt="" class="app__img">
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        <span class="section-subtitle contact__initial">mari kita bicara</span>
                        <h2 class="section-title contact__initial">Hubungi kami</h2>
                        <p class="contact__description">Kepuasan Anda adalah prioritas kami. Jika Anda mengalami kendala saat memesan, memiliki kritik, saran, atau ingin menyampaikan keluhan terkait layanan Q-FOOD, kami siap mendengarkan.</p>
                    </div>

                    <div class="contact__button">
                        <a href="https://wa.me/6287788131822?text=Assalamualaikum%2C%20kak" class="button">Hubungi sekarang</a>
                    </div>
                </div>
            </section>
        </main>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Q-FOOD</a>
                    <span class="footer__description">Delivery</span>
                    <div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="https://wa.me/6287788131822?text=Assalamualaikum%2C%20kak." class="footer__link">Contact us</a></li>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>0877-8813-1822</li>
                        <li>qfood@email.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2025 Q-FOOD. All right reserved</p>
        </footer>
